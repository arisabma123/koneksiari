...
public class Controlling extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDevice = b.getParcelable(HalamanBluetooth.DEVICE_EXTRA);
        mDeviceUUID = UUID.fromString(b.getString(HalamanBluetooth.DEVICE_UUID));
        mMaxChars = b.getInt(HalamanBluetooth.BUFFER_SIZE);
